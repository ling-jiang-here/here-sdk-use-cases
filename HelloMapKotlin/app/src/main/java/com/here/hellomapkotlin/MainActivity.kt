...
//        MapView.setPrimaryLanguage(LanguageCode.DA_DK)
//        MapView.setSecondaryLanguage(LanguageCode.JA_JP)
    ...
    private fun loadMapScene() {
        ...
        mapView?.mapScene?.loadScene(MapScheme.NORMAL_DAY) { mapError ->
            if (mapError == null) {
                ...
                mapView?.camera?.lookAt(GeoCoordinates(52.51604, 13.37691), mapMeasureZoom)
            } else {
    ...
    private fun hidePOIs() {
        ...
        // Step 1: Collect all category IDs from PlaceCategory
        val categoryIds: MutableList<String?> = ArrayList<String?>()
        val fields: Array<Field> = PlaceCategory::class.java.declaredFields
        for (field in fields) {
        ...
        // Step 2: Hide all POI categories
