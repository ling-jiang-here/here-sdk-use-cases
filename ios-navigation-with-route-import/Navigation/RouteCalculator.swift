...
class RouteCalculator {
    ...
    func importRouteFromLocations(routeLocations: [Location],
                        calculateRouteCompletionHandler: @escaping CalculateRouteCompletionHandler) {
        ...
        routingEngine.importRoute(with: routeLocations,
                                     carOptions: carOptions,
                                     completion: calculateRouteCompletionHandler)
    }
    
    func importRouteFromRouteHandle(routeHandle: String,
                        calculateRouteCompletionHandler: @escaping CalculateRouteCompletionHandler) {
        ...
        routingEngine.importRoute(routeHandle: RouteHandle(handle: routeHandle),
                                     refreshRouteOptions: RefreshRouteOptions(CarOptions()),
                                     completion: calculateRouteCompletionHandler)
    }
}
